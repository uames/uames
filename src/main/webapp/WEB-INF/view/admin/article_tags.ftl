...
<head>
	...
	<link href="${rc.contextPath}/css/back-style.css" rel="stylesheet" type="text/css" />	
    <script type="text/javascript" charset="utf-8" src="${rc.contextPath}/js/back-main.js"></script>
</head>
