<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<script language="javascript" charset="utf-8" type="text/javascript" src="${rc.contextPath}/js/filterHtml.js"></script>
	<script language="javascript" charset="utf-8" type="text/javascript" src="${rc.contextPath}/js/front-main.js"></script>
	<style type="text/css">
		.pagination {
			text-align:center;
		}
